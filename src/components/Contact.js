  ...
  return (
    <section id="contact" className="relative text-center">
      ...
      <div className="flex flex-col w-full mb-10">
          <InboxIcon className="text-center mx-auto text-green-400 inline-block w-10 mb-4" />
      ...
      <div className="container px-5 py-10 mx-auto flex sm:flex-nowrap flex-wrap text-left">
        <div className="lg:w-2/3 md:w-1/2 bg-gray-900 rounded-lg overflow-hidden sm:mr-10 p-10 flex items-end justify-start relative">
          <iframe
            ...
            src="https://www.google.com/maps/embed/v1/place?q=nashville&key=AIzaSyBFw0Qbyq9zTFTd-tUY6dZWTgaQzuU17R8"
          />
          <div className="bg-gray-900 relative flex flex-wrap py-6 rounded shadow-md">
            ...
            <div className="lg:w-1/2 px-6 mt-4 lg:mt-0">
              ...
              <p className="leading-relaxed">615.972.6960</p>
            </div>
          </div>
        </div>
        <form
